...
var OperationStore = ( function() 
{
	...
	{
		var elCollectionIcon = $.CreatePanelWithProperties( "ItemImage", elParent, "id-op-store-item-tile__icon", {
	...
	{
		var elImage = $.CreatePanelWithProperties( "ItemImage", elParent , idName, {
	...
	{
		var elPanelBg = $.CreatePanelWithProperties( "Image", elParent , "id-op-shop-tile-bg", { class: 'op-store-item-tile__bg'});
